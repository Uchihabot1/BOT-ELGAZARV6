...
تمت البرمجه بواسطه: 𝒖𝒄𝒉𝒊𝒉𝒂 𝒔𝒂𝒔𝒖𝒌𝒆ꨄ  ,`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
...
ElgazarBot.sendMessage(from, { text: `*${command}*\n\nالاسم : ${q}\nالاجابه : *${sange}%*` }, { quoted: m })
      ...
      case 'اهطل': {
            ...
            let ments = [me, jodoh]
            let buttons = [
                        { buttonId: 'oke', buttonText: { displayText: 'اتفق☺️💟' }, type: 1 }
                    ]
                    await ElgazarBot.sendButtonText(m.chat, buttons, jawab, botname, m, {mentions: ments})
            }
            break
